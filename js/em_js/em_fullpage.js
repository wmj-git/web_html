(function (b) {
    b.fn.fullpage = function (c) {
        ...
        function K(a) {
            var index = a.replace(/page/, "");
            //index获取当前屏幕的编号。用active1...4定义不同的圆点颜色。
            c.menu && (b(c.menu).find("li").removeClass("active").removeClass("active1").removeClass("active2").removeClass("active3").removeClass("active4"), b(c.menu).find('[data-menuanchor="' + a + '"]').addClass("active"+index));
        }
